                ...
                <div className="flex justify-center items-center -ml-10">
                    <Link to="/">
                        <img src={logo} alt="Maticdrive logo"
                            className={`${scrolled ? "w-[35px] h-[35px] ss:w-[50px] ss:h-[50px] duration-1000"
                                : "w-[50px] h-[50px] ss:w-[70px] ss:h-[70px] duration-1000"} 
                                m-2`} />
                    </Link>
                    <div className="flex flex-col -mt-2">
                        <div className={`${scrolled ? "text-[20px] tracking-wider" : "text-[25px] tracking-widest"} font-semibold text-white`}>Matic <span className="text-gradient">Drive</span></div>
                    </div>
                </div>
            </div>
            ...
            <ul className="list-none md:flex hidden justify-end items-center flex-1">
                {navLinks.map((nav) => (
                    <li
                        ...
                        hover:border-b-4 hover:pb-2 hover:border-yellow-300 
                        ${active === nav.title ? "text-white" : "text-gray-500"} 
                        ${scrolled ? "text-[15px] navText1 duration-1000" : "text-[16px] navText2 duration-1000"} 
                ...
                ${scrolled ? "text-[14px] navText1 duration-1000" : "text-[16px] navText2 duration-1000"} 
                font-poppins text-center font-semibold -mr-10 -ml-2 text-gray-500 
