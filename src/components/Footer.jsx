    ...
    return (
        <footer className="w-full flex justify-center items-center bg-gray-900">
            ...
            <div className="w-full flex flex-col justify-center items-center pt-6">
                ...
                <div className="w-full flex flex-row justify-around items-start ss:mb-8 ss:mt-12 sm:mt-4">
                ...
                <div className="w-full flex xs:justify-center justify-start mb-2 xs:mb-2 sm:mb-6 md:mb-3 
                    -mt-1 xs:mt-6 sm:mt-4 md:mt-6">
                    <div className="w-[300px] xs:w-[400px] sm:w-[600px] ml-4 text-gray-400 text-start 
