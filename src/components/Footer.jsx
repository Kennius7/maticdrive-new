        ...
        <footer className="w-full flex justify-center items-center bg-gray-900">
            ...
            <div className="w-full flex flex-col justify-center items-center pt-6">
                ...
                <div className="w-full flex flex-row justify-around items-start ss:mb-8 ss:mt-12">
                    ...
                    <div className="ss:block hidden flex flex-col ss:max-w-[300px]">
                        <Link to="/">
                            <div className={`text-gray-400 ss:mb-4 font-bold ss:text-[17px] 
                                text-[16px]`}>Matic
                                <span className={`text-gradient ss:mb-8 font-bold ss:text-[17px] 
                                    text-[16px]`}> Drive</span>
                            </div>
                        </Link>
                        <p className={`w-full text-gray-400 leading-[25px] text-[14px]`}>
                            Develop your AV business model with our agile team,
                            to create efficient AVs that can deliver optimum services
                            anywhere in Africa.
                        </p>
                    ...
                    <div className="flex flex-col max-w-[160px] ss:max-w-[300px]">
                        <h2 className={`text-gray-400 ss:mb-4 font-bold ss:text-[17px] 
                        text-[16px]`}>Information</h2>
                        <ul className="list-unstyled flex flex-col text-gray-400 ss:text-[14px] 
                        text-[15px]">
                            <li className="ss:mb-1"><Link to="/aboutus">About</Link></li>
                            <li className="ss:mb-1"><Link to="/features">Services</Link></li>
                            <li className="ss:mb-1 ss:tracking-normal tracking-[-1px]"><Link to="/legal" >Privacy &amp; Cookies Policy</Link></li>
                            <li className="ss:mb-1"><Link to="/blog">Blog</Link></li>
                            <li className="ss:mb-1"><Link to="/contactus">Contact Us</Link></li>
                        </ul>
                    </div>

                    <div className={`flex flex-col justify-start max-w-[160px] ss:max-w-[400px]`}>
                        <h2 className={`text-gray-400 font-bold ss:mb-8 mb-2 ss:text-[17px] 
