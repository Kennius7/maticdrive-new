...
function PageTitleTeam() {
    return (
        <div className="w-[65%] flex justify-start items-center absolute z-[2] md:top-[13%] md:left-[2%] 
            ...
            <div className="font-poppins text-dimWhite md:text-[23px] sm:text-[20px] text-[13px] opacity-70 
                md:pl-4 sm:pl-5 pl-3">MEET THE TEAM</div>
            
        </div>
    )
}

export default PageTitleTeam