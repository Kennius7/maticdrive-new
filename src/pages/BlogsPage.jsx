  ...
  return (
    <section className={`bg-primary`}>
      <div className={`flex flex-col justify-center items-center`}>
        ...
        <div className={`w-full flex flex-col ss:h-[500px] h-[300px] justify-center items-center 
        overflow-hidden`}>
          ...
          <div className="flex flex-col justify-center items-center ss:-mt-[500px] mt-[150px]">
